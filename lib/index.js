...
var objectMutator = require('./objectMutator.js');
...
var mutate = {
    string: (function() {
      return function(seed){
        return (seed !== null && seed !== undefined)? surku['string'](seed) : vectorize.rand()
      }
    })(),
    number: (function() {
      return function(seed){
    ...
    date: (function() {
      ...
      object: (function() {
      return function(seed){
          return (seed !== null && seed !== undefined)? om(seed) :  createRandomObj();
        }
    })(),
      any: (function() {
      return function(seed){
    ...
    function asyncify(type) {
      return function(seed, cb) {
        var payload;
        payload = mutate[type]((seed !== null && seed !== undefined)? String(seed): undefined);
